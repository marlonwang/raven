package net.logvv.raven.push.xg.xinge;
...
public class XingeClient {
	...
	// 测试方法
    public static JSONObject queryTokenInfo(long accessId, String secretKey, String deviceToken) throws JSONException {
        
        XingeClient xinge = new XingeClient(accessId, secretKey);   
        return xinge.queryInfoOfToken(deviceToken);
    }
	...
	public JSONObject pushSingleDevice(String deviceToken, Message message) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_PUSHSINGLEDEVICE, params);
	}
	...
	public JSONObject pushAccountList(int deviceType, List<String> accountList, Message message) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_PUSHACCOUNTLIST, params);
	}
	...
	public JSONObject pushSingleAccount(int deviceType, String account, Message message) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_PUSHSINGLEACCOUNT, params);
	}
	...
	public JSONObject pushAllDevice(int deviceType, Message message) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_PUSHALLDEVICE, params);
	}
	...
	public JSONObject pushTags(int deviceType, List<String> tagList, String tagOp, Message message) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_PUSHTAGS, params);
	}
	...
	public JSONObject createMultipush(Message message) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_CREATEMULTIPUSH, params);
	}
	...
	public JSONObject pushAccountListMultiple(int pushId, List<String> accountList) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_PUSHACCOUNTLISTMULTIPLE, params);
	}
	...
	public JSONObject pushDeviceListMultiple(int pushId, List<String> deviceList) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_PUSHDEVICELISTMULTIPLE, params);
	}
	...
	public JSONObject queryPushStatus(List<String> pushIdList) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_QUERYPUSHSTATUS, params);
	}
	
	public static JSONObject getDeviceNum(long accessId, String secretKey) throws JSONException
	{
	    XingeClient xinge = new XingeClient(accessId, secretKey);
	    return xinge.queryDeviceCount();
	}
	...
	public JSONObject queryDeviceCount() throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_QUERYDEVICECOUNT, params);
	}
	...
	public JSONObject queryTags(int start, int limit) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_QUERYTAGS, params);
	}
	...
	public JSONObject queryTagTokenNum(String tag) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_QUERYTAGTOKENNUM, params);
	}
	...
	public JSONObject queryTokenTags(String deviceToken) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_QUERYTOKENTAGS, params);
	}
	...
	public JSONObject cancelTimingPush(String pushId) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_CANCELTIMINGPUSH, params);
	}
	
	public XingeClient(long accessId, String secretKey)
	{
	...
	protected String generateSign(String method, String url, Map<String, Object> params)
	{
		...
		try
		{
			...
			//System.out.println(s);// TODO 测试参与签名的参数串
		}
		catch(Exception e)
		{
			//e.printStackTrace();
	...
	protected JSONObject callRestful(String url, Map<String, Object> params) throws JSONException 
	{
		...
		//System.out.println(sign); // TODO 测试生成的签名md5
		...
		try{
			...
			int keySetSize = params.keySet().size();
			int keyIndex = 0;
			...
			System.out.println(param);// TODO 测试输出最终的请求参数
            ...
            isr.close();
            conn.disconnect();
            System.out.println(ret); // TODO 测试输出 信鸽返回的结果
            // TODO 测试输出
	...
	public JSONObject BatchSetTag(List<TagTokenPair> tagTokenPairs) throws JSONException 
	{
	    ...
	    params.put("tag_token_list", new JSONArray(tag_token_list).toString());
	  	...
	  	return callRestful(XingeClient.RESTAPI_BATCHSETTAG, params); 
	}
	...
	public JSONObject BatchDelTag(List<TagTokenPair> tagTokenPairs) throws JSONException 
	{
	    ...
	    params.put("tag_token_list", new JSONArray(tag_token_list).toString());
	  	...
	  	return callRestful(XingeClient.RESTAPI_BATCHDELTAG, params); 
	}
	...
	public  JSONObject queryInfoOfToken(String deviceToken) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_QUERYINFOOFTOKEN, params);
	}
	
	// 测试方法
	public static JSONObject getTokenOfAccount(long accessId, String secretKey,String account) throws JSONException
	{
	    XingeClient xinge = new XingeClient(accessId, secretKey);
	    return xinge.queryTokensOfAccount(account);
	}
	...
	public JSONObject queryTokensOfAccount(String account) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_QUERYTOKENSOFACCOUNT, params);
	}
	...
	public JSONObject deleteTokenOfAccount(String account, String deviceToken) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_DELETETOKENOFACCOUNT, params);
	}
	...
	public JSONObject deleteAllTokensOfAccount(String account) throws JSONException
	{
		...
		return callRestful(XingeClient.RESTAPI_DELETEALLTOKENSOFACCOUNT, params);
	}
